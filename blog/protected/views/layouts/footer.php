...
<div class="container-fluid navbar-fixed-bottom bg-light bg-gradient shadow-lg mt-5">
  <footer class="py-3 my-4">
    <ul class="container nav justify-content-center border-bottom pb-3 mb-3">
        ...
        <li class="nav-item"><a href="<?= Yii::app()->request->baseUrl; ?>/index.php?r=categoria" class="nav-link px-2 text-muted">Categorias</a></li>
        <li class="nav-item"><a href="<?= Yii::app()->request->baseUrl; ?>/index.php?r=contact" class="nav-link px-2 text-muted">Sobre</a></li>
